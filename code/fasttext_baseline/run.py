...
def _jsonl_to_fasttext_format(input_path: str, output_path: str) -> None:
    ...
    with jsonlines.open(input_path) as f_in, \
            open(output_path + ".de", "w", encoding="utf-8") as f_out_de, \
            open(output_path + ".fr", "w", encoding="utf-8") as f_out_fr, \
            open(output_path + ".it", "w", encoding="utf-8") as f_out_it:
        for line in f_in:
    ...
    for language in ["de", "fr", "it"]:
        with open(output_path + ".{}".format(language), encoding="utf-8") as f_in, \
                open(output_path + ".tokenized.{}".format(language), "w", encoding="utf-8") as f_out:
            subprocess.call([
                r"C:\rtools43\usr\bin\perl.exe",
    ...
    with open(output_path, "w", encoding="utf-8") as f_out, \
            open(output_path + ".tokenized.de", encoding="utf-8") as f_in_de, \
            open(output_path + ".tokenized.fr", encoding="utf-8") as f_in_fr, \
            open(output_path + ".tokenized.it", encoding="utf-8") as f_in_it:
